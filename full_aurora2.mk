...
DEVICE_PACKAGE_OVERLAYS := device/ainol/aurora2/overlay
...
# USB ModeSwitch
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/ainol/aurora2/configs/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Prebuilt kernel modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/ainol/aurora2/modules,system/lib/modules)
...
$(call inherit-product-if-exists, vendor/ainol/aurora2/aurora2-vendor.mk)
