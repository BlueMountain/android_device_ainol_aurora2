...
-include vendor/ainol/aurora2/BoardConfigVendor.mk
...
BOARD_EGL_CFG := device/ainol/aurora2/egl.cfg
USE_OPENGL_RENDERER := true
ENABLE_WEBGL := true
BOARD_USE_SKIA_LCDTEXT := true

# CWM
#TARGET_RECOVERY_INITRC := device/ainol/aurora2/recovery.init.rc
...
TARGET_PREBUILT_KERNEL := device/ainol/aurora2/kernel
BOARD_KERNEL_BASE := 0x40000000
BOARD_KERNEL_CMDLINE := console=ttyS0,115200 rw init=/init loglevel=8

TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/ainol/aurora2/releasetools/amlogic_ota_from_target_files
